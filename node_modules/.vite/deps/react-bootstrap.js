...
} from "./chunk-H7O7AP67.js";
import {
  Button_default,
  Button_default2,
  useButtonProps
} from "./chunk-HBLUX5XM.js";
import {
  Container_default
} from "./chunk-ZP5EOANF.js";
import {
  Col_default,
  ...
  require_warning,
  useCol
} from "./chunk-XEOUSJYO.js";
import {
  createWithBsPrefix
} from "./chunk-RSEBWDJH.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-4WVDNXYI.js";
import {
  require_jsx_runtime
} from "./chunk-57Q6REKV.js";
import {
  require_react_dom
...
var Carousel = React24.forwardRef((uncontrolledProps, ref) => {
  const {
    as: Component2 = "div",
    bsPrefix,
    slide,
...
function useDropdownMenu(options = {}) {
  const context5 = (0, import_react36.useContext)(DropdownContext_default);
...
var SelectableContext = React28.createContext(null);
...
var NavContext = React29.createContext(null);
...
var DropdownToggle2 = React37.forwardRef(({
  ...
  return (0, import_jsx_runtime31.jsx)(Component2, {
    className: (0, import_classnames20.default)(className, prefix, split && `${prefix}-split`, !!isInputGroup && (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
    ...toggleProps,
    ...props
  });
});
  ...
  return (0, import_jsx_runtime32.jsx)(DropdownContext_default2.Provider, {
    ...
    children: (0, import_jsx_runtime32.jsx)(Dropdown_default, {
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime32.jsx)(Component2, {
        ...props,
        ref,
        className: (0, import_classnames21.default)(className, show && "show", (!drop || drop === "down") && prefix, drop === "up" && "dropup", drop === "end" && "dropend", drop === "start" && "dropstart")
      })
    })
  });
});
...
Image2.defaultProps = defaultProps14;
...
var TabContext = React43.createContext(null);
...
var NavItem = React44.forwardRef((_ref, ref) => {
  let {
    as: Component2 = Button_default,
    active,
    eventKey
...
var Nav = React45.forwardRef((_ref, ref) => {
  let {
    as: Component2 = "div",
    onSelect,
    activeKey,
...
var Modal = (0, import_react50.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime42.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime42.jsx)("div", Object.assign({}, dialogProps, {
    children: React48.cloneElement(children, {
      role: "document"
    })
  }));
  if (Transition2) {
    dialog = (0, import_jsx_runtime42.jsx)(Transition2, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition3) {
      backdropElement = (0, import_jsx_runtime42.jsx)(BackdropTransition3, {
        appear: true,
        in: !!show,
  ...
  return (0, import_jsx_runtime42.jsx)(import_jsx_runtime43.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime44.jsxs)(import_jsx_runtime43.Fragment, {
...
var ModalContext = React49.createContext({
  onHide() {
  }
});
...
var AbstractModalHeader = React51.forwardRef(({
  closeLabel,
  closeVariant,
  closeButton,
  onHide,
  ...
  const context5 = (0, import_react51.useContext)(ModalContext_default);
  const handleClick = useEventCallback(() => {
    context5 == null ? void 0 : context5.onHide();
    onHide == null ? void 0 : onHide();
  });
  return (0, import_jsx_runtime47.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime46.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick
    })]
...
AbstractModalHeader.defaultProps = defaultProps16;
...
var Modal2 = React53.forwardRef(({
  ...
  const renderBackdrop = (0, import_react52.useCallback)((backdropProps) => (0, import_jsx_runtime49.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime49.jsx)("div", {
    ...
    className: (0, import_classnames29.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`),
...
Modal2.defaultProps = defaultProps18;
...
var NavLink = React54.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
  ...
  return (0, import_jsx_runtime50.jsx)(Component2, {
    ...
    ...navItemProps,
    ref,
    className: (0, import_classnames30.default)(className, bsPrefix, props.disabled && "disabled", meta.isActive && "active")
  });
});
NavLink.displayName = "NavLink";
NavLink.defaultProps = defaultProps19;
...
var Nav2 = React55.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
Nav2.defaultProps = defaultProps20;
...
var NavbarBrand = React56.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React57.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context5 = (0, import_react54.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime53.jsx)(Collapse_default, {
...
var NavbarToggle = React58.forwardRef(({
  bsPrefix,
  className,
  children,
  label,
  ...
  return (0, import_jsx_runtime54.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime54.jsx)("span", {
      className: `${bsPrefix}-icon`
    })
  });
});
NavbarToggle.displayName = "NavbarToggle";
NavbarToggle.defaultProps = defaultProps21;
...
var OffcanvasToggling = React59.forwardRef(({
  bsPrefix,
  className,
  children,
  ...props
  ...
  return (0, import_jsx_runtime55.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React59.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames34.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
OffcanvasToggling.defaultProps = defaultProps22;
...
var OffcanvasHeader = React60.forwardRef(({
  bsPrefix,
  className,
  ...props
}, ref) => {
...
OffcanvasHeader.defaultProps = defaultProps23;
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime57.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React61.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react58.useCallback)((backdropProps) => (0, import_jsx_runtime57.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames36.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime57.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames36.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime59.jsxs)(import_jsx_runtime58.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime57.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
Offcanvas.defaultProps = defaultProps24;
...
var NavbarOffcanvas = React62.forwardRef((props, ref) => {
  const context5 = (0, import_react59.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime60.jsx)(Offcanvas_default, {
    ref,
  ...
  return (0, import_jsx_runtime61.jsx)(NavbarContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime61.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime61.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames37.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
Navbar.defaultProps = defaultProps25;
...
var Overlay = React65.forwardRef((props, outerRef) => {
  ...
  if (Transition2) {
    ...
    child = (0, import_jsx_runtime64.jsx)(Transition2, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
Popover.defaultProps = defaultProps26;
...
Overlay2.defaultProps = defaultProps27;
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime70.jsxs)(import_jsx_runtime69.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react65.cloneElement)(children, triggerProps), (0, import_jsx_runtime68.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
OverlayTrigger.defaultProps = defaultProps28;
...
var SplitButton = React78.forwardRef(({
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime81.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime80.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime80.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
...
function useTabPanel(_ref) {
  ...
  const context5 = (0, import_react68.useContext)(TabContext_default);
  if (!context5)
  ...
  (_ref2, ref) => {
    ...
    return (0, import_jsx_runtime83.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime83.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime83.jsx)(Transition2, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
...
var TabPane = React83.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime86.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime86.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime86.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime88.jsx)(import_jsx_runtime87.Fragment, {});
};
...
var Table = React85.forwardRef(({
  ...
  const classes = (0, import_classnames50.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime90.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime90.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime91.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime90.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      children: map(children, renderTab)
    }), (0, import_jsx_runtime90.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime90.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React87.forwardRef((props, ref) => (0, import_jsx_runtime92.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React89.forwardRef(({
  ...
  const context5 = (0, import_react70.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = React90.forwardRef(({
  ...
  const delayRef = (0, import_react71.useRef)(delay);
  const onCloseRef = (0, import_react71.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react71.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react71.useMemo)(() => ({
    onClose
  }), [onClose]);
  ...
  return (0, import_jsx_runtime95.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime95.jsx)(Transition2, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
